          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                // '</div>' +
                // '</div>' 
                '<a href="{{route('tenant.view')}}" class="item-edit pe-2">' +
                feather.icons['eye'].toSvg({ class: 'font-medium-4'  }) +
                '</a>' +
                '<a href="javascript:;" class="item-edit pe-2"><button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#inlineForm">' +
