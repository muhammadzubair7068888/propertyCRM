           ...
           // Label
            ...
            render: function (data, type, full, meta) {
              ...
              var $status = {
                ...
                3: { title: 'Pending', class: ' badge-light-primary' },
                4: { title: 'Approved', class: ' badge-light-success' },
                5: { title: 'Pending', class: ' badge-light-primary' }
              };
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                'Details</button></a>' +
                '<a href="{{route('tenant.payment.create')}}" class="dropdown-item"><button type="button" class="btn">' + 
