    ...
    <section class="vertical-wizard">
        <div class="bs-stepper vertical vertical-wizard-example">
            ...
            <div class="bs-stepper-content">
                <form action="{{ @$tenant? route('admin.tenant.update',$tenant->id): route('admin.tenant.store') }}" method="post">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="first-name-column" class="form-control" placeholder="First Name"
                                    name="form[user][first_name]" value="{{@$tenant->user->first_name ?? old('form[user][first_name]')}}" />
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="middle-name-column" class="form-control" placeholder="Middle Name"
                                    name="form[user][middle_name]" value="{{@$tenant->user->middle_name ?? old('form[user][middle_name]')}}" />
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="vertical-last-name" class="form-control"
                                    name="form[user][last_name]" placeholder="Last Name" value="{{@$tenant->user->last_name ?? old('form[user][last_name]')}}" />
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <select class="form-select" id="gender" name="form[user][gender]"  value="{{@$tenant->user->gender ?? old('form[user][gender]')}}">
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="Kin-relation" class="form-control" placeholder="Kin Relation"
                                    name="form[tenantInfo][kin_relation]" value="{{@$tenant->kin_relation ?? old('form[tenantInfo][kin_relation]')}}" />
