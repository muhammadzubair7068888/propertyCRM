    ...
    <section class="vertical-wizard">
        <div class="bs-stepper vertical vertical-wizard-example">
            ...
            <div class="bs-stepper-content">
                <form action="{{ route('admin.leases.update',$leaseInfo->id) }}" method="post">
                    @csrf
                    ...
                    <div id="account-details-vertical" class="content" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <select class="select2 form-select" readonly id="lease-property" name="form[property_id]">
                                    <option value=""></option>
                                    @foreach ($property as $properties)
                                        <option value="{{ $properties->id }}" {{ $properties->id == $selected_property->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <select class="select2 form-select" id="lease-type" name="form[lease_type_id]" required>
                                    ...
                                    @foreach ($leasetype as $lease)
                                        <option value="{{ $lease->id }}" {{$lease->id == $selected_property->leases[0]->lease_type->id ? 'selected' : ''}} >{{$lease->name}}</option>
                                    @endforeach
                            ...
                            <div class="mb-1 form-password-toggle col-md-6">
                                ...
                                <input type="text" id="rent-amount" class="form-control" placeholder="rent_amount"
                                    name="form[rent_amount]" value="{{$selected_property->leases[0]->rent_amount}}" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="date" id="lease-date" class="form-control flatpickr-basic"
                                    placeholder="YYYY-MM-DD" name="form[start_date]" value="{{$selected_property->leases[0]->start_date}}" required />
                            </div>
                            <div class="mb-1 col-md-6">
                                ...
                                <select class="select2 form-select" id="lease-date" name="form[due_on]"  required>
                                    <option value=""></option>
                                    @for ($i = 1; $i <= 28; $i++)
                                        <option value="{{ $i }}" {{$i == $selected_property->leases[0]->due_on ? 'selected' : ''}}>{{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="mb-1 col-md-12">
                                    ...
                                    <input type="number" id="rent-deposit-amount" class="form-control"
                                        placeholder="Rent Deposit Amount" name="form[rental_deposit_amount]" value="{{$selected_property->leases[0]->rental_deposit_amount}}"  />
                                </div>
                                <div id="payment">
                                    <div class="row d-flex align-items-end rept">
                                        ...
                                        <div class="mb-1 col-md-5">
                                            ...
                                            <select class="select2 w-100" id="utility-names"
                                                ...
                                                @foreach ($utility as $utility)
                                                    <option value="{{ $utility->id }}" {{$utility->id ==$selected_property->propertyUtility[0]->util_name->id ? 'selected': ''}}>{{ $utility->name }}</option>
                                                @endforeach
                                        ...
                                        <div class="mb-1 col-md-5">
                                            ...
                                            <input type="number" id="deposit-amount" class="form-control"
                                                placeholder="deposit-amount" name="deposit[deposit_amounts][]" value="{{$selected_property->leases[0]->rental_deposit_amount}}" />
                            ...
                            <div class="mb-1 col-md-12">
                                ...
                                <select class="select2 w-100 " id="tenant" name="form[tenant_info_id]">
                                    ...
                                    @foreach ($tenant as $tenant)
                                        <option value="{{ $tenant->id }}" {{ $tenant->id == $leaseInfo->tenant_info->id ? 'selected' : '' }}>{{ $tenant->user->first_name }}
                            ...
                            <div class="row">
                                <div class="mb-1 col-md-12">
                                    ...
                                    <select class="select2 form-select" id="generate-invoice"
                                        ...
                                        <option value=""></option>
                                        @for ($i = 1; $i <= 28; $i++)
                                        <option value="{{ $i }}" {{$i == $selected_property->leases[0]->generate_invoice ? 'selected' : ''}}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="form-check form-check-primary">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="colorCheck1"
                                        name="form[next_period_bill]" value="1" {{ $leaseInfo->next_period_bill == 1 ? 'checked' : '' }} />
                            ...
                            <div class="row">
                                <div class="form-check form-check-primary">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="colorCheck2"
                                        name="form[waive_penalty]" value="1" {{ $leaseInfo->waive_penalty == 1 ? 'checked' : '' }}/>
                            ...
                            <div class="row mb-2">
                                <div class="form-check form-check-primary">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="colorCheck3"
                                        name="form[skip_starting_period]" value="1" {{ $leaseInfo->skip_starting_period == 1 ? 'checked' : '' }}/>
...
@section('page-script')
    ...
    <script>
        ...
        function propertyLoad(){
            ...
            $("#util").empty();
            $("#pay").empty();
            var selected_property = $('#lease-property').find('option:selected').val();
