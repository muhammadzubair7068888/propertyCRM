                        ...
                        <table class="datatables-table table">
                            ...
                            <tbody>
                              ...
                              $name='';
                                ...
                                $pay = number_format($invoice->leaseInfo->rent_amount + $invoice->leaseInfo->rental_deposit_amount + $invoice->leaseInfo->deposit->deposit_amount, 2)
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="{{route('admin.invoice.downloadInvoice',$invoice->id)}}" class="item-edit text-success" data-bs-toggle="tooltip" data-bs-placement="top" title="download"><i data-feather='download' class='font-medium-4' ></i>
                                    </a>
                                </td>
