 ...
 {{-- <div class="row">
    <div class="col-lg-3 col-sm-6">
      <div class="card">
        <div class="card-body d-flex align-items-center justify-content-between">
          <div>
            <h3 class="fw-bolder mb-75">Payment History</h3>
            <span>Pending</span>
          </div>
    ...
    <div class="col-lg-3 col-sm-6">
      <div class="card">
        <div class="card-body d-flex align-items-center justify-content-between">
          <div>
            <h3 class="fw-bolder mb-75">Wavier History</h3>
      ...
      <div class="col-lg-6 col-sm-6">
        <div class="card">
          <div class="card-body d-flex align-items-center justify-content-between">
            <div>
              <h3 class="fw-bolder mb-75">Property</h3>
              <span>property-name</span>
            </div>
            <div>
                <h3 class="fw-bolder mb-75">Lease</h3>
                <span>lease-name</span>
              </div>
              <div>
                <h3 class="fw-bolder mb-75">Unit</h3>
                <span>unit name</span>
              </div>
              <div>
                <h3 class="fw-bolder mb-75">Tenant</h3>
