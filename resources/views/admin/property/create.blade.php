                    ...
                    <div id="account-details-vertical" class="content" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="vertical-property"
                                    class="form-control @error('form[property][property_name]')
                                border-1 border-danger
                                @enderror"
                                    placeholder="Property Name" name="form[property][property_name]" />
                                @error('form[property][property_name]')
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="vertical-property-code"
                                    class="form-control @error('form[property][property_code]')
                                border-1 border-danger
                                @enderror"
                                    placeholder="Property Code" name="form[property][property_code]" aria-label="" />
                                @error('form[property][property_code]')
                                    <div class="text-danger">{{ $message }} </div>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-1 form-password-toggle col-md-12">
                                ...
                                <input type="text" id="vertical-location" name="form[property][location]"
                                    class="form-control @error('form[property][location]')
                                   border-1 border-danger
                                @enderror"
                                    placeholder="Location" />
                                @error('form[property][location]')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <select class="select2 form-select @error('form[property][user_id]') border-1 border-danger @enderror"
                                    id="basicSelect" name="form[property][user_id]">
                                ...
                                @error('form[property][user_id]')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-1 col-md-6">
                                <label class="form-label" for="property-type">Property Type</label>
                                <select class="select2 w-100 @error('form[property][property_type_id]') border-1 border-danger @enderror"
                                    id="property-type" name="form[property][property_type_id]">
                                    @foreach ($propertyTypes as $propertyType)
                                        <option value="{{ $propertyType->id }}">{{ $propertyType->name }}</option>
                                    @endforeach
                                </select>
                                @error('form[property][property_type_id]')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                            ...
                            <div action="#" id="sourceForm">
                                <div class="row d-flex align-items-end rept">
                                    <div class="col-md-10 col-12">
                                        <div class="mb-1">
                                            <input type="text" readonly class="form-control" onclick="unitModal()"
                                                id="unitName" placeholder="Units" />
                                        </div>
                                    </div>
                    ...
                    <div id="personal-info-vertical" class="content" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="number" id="agent-commission-value"
                                    class="form-control @error('form[payment][agent_commission_value]') border-1 border-danger @enderror"
                                    placeholder="Agent Commission Value" name="form[payment][agent_commission_value]" />
                                @error('form[payment][agent_commission_value]')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-1 col-md-6">
                                ...
                                <select
                                    class="select2 w-100 @error('form[payment][agent_commission_type]') border-1 border-danger @enderror"
                                    id="agent-commission-type" name="form[payment][agent_commission_type]">
                                    <option label=" "></option>
                                ...
                                @error('form[payment][agent_commission_type]')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <select class="select2 w-100 @error('form[payment][payment_method]') border-1 border-danger @enderror"
                                    id="payment-method" name="form[payment][payment_method][]">
                                ...
                                @error('form[payment][payment_method]')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="number" id="payment-description"
                                    class="form-control @error('form[payment][payment_description]') border-1 border-danger @enderror"
                                    placeholder="Payment Description" name="form[payment][payment_description][]" />
                                @error('form[payment][payment_description]')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="extra-charges-name">Extra Charges
                                                        Name</label>
                                                    <select
                                                        class="select2 w-100 @error('form[extra_charge][extra_charge_name]') border-1 border-danger @enderror"
                                                        id="extra-charges-name" name="form[extra_charge][extra_charge_name][]">
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" class="form-control " id="extra-charges-value"
                                                        ...
                                                        name="form[extra_charge][extra_charges_value][]" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select
                                                        ...
                                                        id="extra-charges-type" name="form[extra_charge][extra_charges_type][]">
                                                        <option label=" "></option>
                                                        <option>Fixed Value</option>
                                                        <option>% Of Total Rent</option>
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select
                                                        ...
                                                        id="frequency" name="form[extra_charge][extra_charges_frequency][]">
                                                        <option label=" "></option>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="row">
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <select
                                                        class="select2 w-100 @error('form[late_fee][late_fee_name]') border-1 border-danger @enderror"
                                                        id="late-fee-name" name="form[late_fee][late_fee_name][]">
                                                        <option label=" "></option>
                                                        <option>Penalty</option>

                                                    </select>
                                                    @error('form[late_fee][late_fee_name]')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <input type="number" id="late-fee-value"
                                                        class="form-control @error('form[late_fee][late_fee_value]') border-1 border-danger @enderror"
                                                        placeholder="Late Fee Value" name="form[late_fee][late_fee_value][]" />
                                                    @error('form[late_fee][late_fee_value]')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <select
                                                        class="select2 w-100 @error('form[late_fee][late_fee_type]') border-1 border-danger @enderror"
                                                        id="late-fee-type" name="form[late_fee][late_fee_type][]">
                                                        <option label=" "></option>
                                                        <option>Fixed Value</option>
                                                        <option>% Of Total Rent</option>
                                                        <option>% Of Total Amount Over Due</option>
                                                    </select>
                                                    @error('form[late_fee][late_fee_type]')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <input type="number" id="grace-period"
                                                        class="form-control @error('form[late_fee][late_fee_grace_period]') border-1 border-danger @enderror"
                                                        placeholder="Grace Period(Days)" name="form[late_fee][late_fee_grace_period]" />
                                                    @error('form[late_fee][late_fee_grace_period]')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    <label class="form-label" for="frequency">Frequency</label>
                                                    <select
                                                        class="select2 w-100 @error('form[late_fee][late_fee_frequency]') border-1 border-danger @enderror"
                                                        id="frequency" name="form[late_fee][late_fee_frequency][]">
                                                        <option label=" "></option>
                                                        <option>One Time</option>
                                                        <option>Daily</option>
                                                    ...
                                                    @error('form[late_fee][late_fee_frequency]')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="mb-1">
                                                ...
                                                <select
                                                    class="select2 w-100 @error('form[utility][utility_name]') border-1 border-danger @enderror"
                                                    id="utility-name" name="form[utility][utility_name][]">
                                                    <option label=" "></option>
                                                    <option>Water</option>
                                                    <option>Gas</option>
                                        ...
                                        <div class="col-md-2 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="number" class="form-control" id="itemcost"
                                                    aria-describedby="itemcost" placeholder="32" name="form[utility][utility_cost][]" />
                                            </div>
                                        </div>
