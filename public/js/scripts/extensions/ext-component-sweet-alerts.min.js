  ...
  $('#basic-alert').on('click', function () {
    ...
    $('#auto-close').on('click', function () {
      ...
      Swal.fire({
        ...
        t.dismiss === Swal.DismissReason.timer && /* eslint-disable */console.log(...oo_oo(`3857071742_0`,'I was closed by the timer'));
      });
    }),
      ...
      Swal.fire({
        ...
        preConfirm: function (t) {
          return fetch('//api.github.com/users/' + t)
            .then(function (t) {
              if (!t.ok) throw (/* eslint-disable */console.log(...oo_oo(`3857071742_1`,t)), new Error(t.statusText));
              return t.json();
            })
            .catch(function (t) {
